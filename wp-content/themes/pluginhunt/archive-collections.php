...
?>
<header class="collection-category--header" style="background-image:url(undefined);" data-reactid=".2.0"><div class="collection-category--header--shadow" data-reactid=".2.0.0"><div class="collection-category--header--heading" data-reactid=".2.0.0.0"><h1><?php _e('Featured Collections','ph_theme'); ?></h1><h2><?php _e('Collections of great plugins, updated daily','ph_theme'); ?></h2></div><div class="collection-category--header--share" data-reactid=".2.0.0.1"><a class="collection-category--header--share--item v-twitter share" href="<?php echo get_permalink();?>" title="<?php the_title(); ?>" data-action="twitter"><span data-reactid=".2.0.0.1.0.0"><!--?xml version="1.0" encoding="UTF-8" standalone="no"?-->
...
</span></a><a class="collection-category--header--share--item v-facebook share" href="<?php echo get_permalink();?>" title="<?php the_title(); ?>" data-action="facebook"><span><svg width="8" height="13" viewBox="0 0 8 14" xmlns="http://www.w3.org/2000/svg"><path d="M7.2 2.323H5.923c-1.046 0-1.278.464-1.278 1.16V5.11h2.44l-.35 2.438h-2.09v6.387H2.09V7.548H0V5.11h2.09V3.252C2.09 1.162 3.368 0 5.342 0c.93 0 1.742.116 1.858.116v2.207z" fill="#FFF" fill-rule="evenodd"></path></svg></span></a></div></div></header>
