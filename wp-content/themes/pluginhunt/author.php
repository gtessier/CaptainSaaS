...
<header class="page-header">
  ...
  <ul>
    <li class="page-header--navigation--tab m-active" id = 'ah-upvoted'>
      <a href="#"><strong><?php echo $cu; ?></strong> Upvoted</a>
    </li>
      <li class="page-header--navigation--tab" id = 'ah-submitted'>
        <a href="#"><strong><?php echo $cs; ?></strong> Submitted</a>
      </li>
...
-->
    <?php 
    //user collections plugin needs to be activated 
    if(function_exists('ph_user_collections')){ ?>
      <li class="page-header--navigation--tab" id = 'ah-collections'>
        <a href="#"><strong>13</strong> Collections</a>
      </li>
    <?php } ?>
    <li class="page-header--navigation--tab" id = 'ah-followers'>
      <a href="#"><strong><?php echo $cfr; ?></strong> Followers</a>
    </li>
    <li class="page-header--navigation--tab" id = 'ah-following'>
      <a href="#"><strong><?php echo $cfd; ?></strong> Following</a>
    </li>
  </ul>
</nav>
