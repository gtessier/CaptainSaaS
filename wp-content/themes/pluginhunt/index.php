 ...
 <?php setup_postdata($post); 
			...
			<?php } ?>
						...
						// $title = substr( $title, 0, 37) . "...";
						 ...
						 if($out ==''){?>
						<a class='title title-<?php echo $post->ID;?>' href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php echo $title; ?></a>						 	
					 	<?php }else if(wp_is_mobile()){?>
						<a class='title title-<?php echo $post->ID;?>' href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php echo $title; ?></a>
						<?php }else{ ?>
						<a class='title title-<?php echo $post->ID;?>' href="<?php echo esc_url($out); ?>" title="<?php the_title_attribute(); ?>" target="_blank" rel="nofollow"><?php echo $title; ?></a>
						<?php	}
						}else{ ?>
						<a class='title title-<?php echo $post->ID;?>'href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" target="_blank"><?php echo $title; ?></a>
						<?php } ?>				
