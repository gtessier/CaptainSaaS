...
{
	?>
<div class="alert alert-danger" role="alert"><?php _e("Login failed: You have entered an incorrect Username or password, pease try again.", "ph_theme"); ?></div>
	...
	<?php
			    ...
			    <form class="omb_loginForm" name="loginform" id="loginform" action="<?php echo $surl; ?>/wp-login.php?action=login" autocomplete="off" method="POST">
					...
					<button class="btn btn-lg btn-danger btn-block" type="submit"><?php _e('Login','ph_theme'); ?></button>
		...
		<div class = 'ph_bt'><?php _e("Back to ", "ph_theme"); ?><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo('name'); ?></a></div> 	
	</div>
