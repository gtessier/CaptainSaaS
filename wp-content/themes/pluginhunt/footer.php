        ...
        <div class="modal-content-fullscreen">
            <div class="overlay-dialog overlay-dialog--signin overlay-dialog--animate js-overlayDialog" tabindex="-1">
              ...
              <br/>
                ...
                <div class="overlay-content"><?php _e('Sign in to','ph_theme');?>  <?php bloginfo('name'); ?> <?php _e('or create an account','ph_theme');?></div>
                                ...
                                <div class='ph-tw'><i class="fa fa-twitter"></i><?php _e('Sign in with Twitter','ph_theme'); ?></div></a>
                                </div>
                                ...
                                <div class='ph-fb'><i class="fa fa-facebook"></i><?php _e('Sign in with Facebook','ph_theme'); ?></div></a>
                                </div>
                                </div>

                                <div class='ph-or'>
                                    <p class='ph-or-p'><?php _e('Or, login','ph_theme'); ?><a href="<?php echo wp_login_url(); ?>" title="Login"> <?php _e('normally','ph_theme'); ?></a></span></p>
                                </div>


                                <div class="signinPrivacyMessages">
                                    <?php _e('We will never post to Twitter or Facebook without your permission.','ph_theme'); ?>
                                </div>
...
<div class="ph_popover v-bottom-center"  style="top: 274px; left: 870px;"><div data-reactid=".0.2.0"><div class="popover--header" data-reactid=".0.2.0.0"><h3 class="popover--header--title" data-reactid=".0.2.0.0.0"><?php _e('Add to Collection','ph_theme');?></h3><a class="popover--header--icon" data-action="open-modal" data-layout="fullscreen" href="/faq#collection"><span>
...
<div class='cmsg'>
  ...
  <div class="popover--footer" data-reactid=".0.2.0.1.1">
    <a class="collections-popover--form-trigger" href="#"><?php _e('Add New','ph_theme'); ?></a>
    <div class='collections-form'>
        <form class="collections-popover--form"><input class="collections-popover--form--field input" placeholder="Collection name" type="text"><input class="collections-popover--form--submit button v-green" type="submit" value="Add" data-reactid=".0.2.0.1.1.0.1"></form>
    </div>
  </div>
</div>
</div>
...
<!-- our new popover for media - could utilise for other clicks too -->
<div class="ph_popover_media v-bottom-center"  style="top: 274px; left: 870px;">
<div class="add-product-link-popover">
  <div class="popover--header">
    <h3 class="popover--header--title">Add product media</h3>
    <div class="popover--header--description">
      Enter the URL of an image or YouTube video:
    </div>
  </div>
  ...
  <div class="popover--simple-form--actions">
    <input type="submit" name="commit" value="Add media" class="button v-green" data-disable-with="Saving...">
  </div>
</form>
</div>
